    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
            ...
            <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
                ...
                <h1 className="text-4xl font-bold mt-3 text-red-500">{summary?.lowStockMedicinesCount}</h1>
            ...
            <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
                ...
                <h1 className="text-4xl font-bold mt-3 text-blue-500">{summary?.expiringMedicinesCount}</h1>
            ...
            <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
                ...
                <h1 className="text-4xl font-bold mt-3 text-purple-500">{summary?.todayDosesCount}</h1>
